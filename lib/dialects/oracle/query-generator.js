      ...
      if (autoIncrementKeys.length > 0) {
        for (var ikey in autoIncrementKeys) {
          ...
          sequences += '\n\n' + Utils._.template(sequenceTpl)({
            sequence: this.quoteIdentifier(tableName.slice(0,10) + '_' + autoIncrementKeys[ikey].slice(0,10) + '_SEQ')
          }).trim();

          triggers += '\n\n' + Utils._.template(triggerTpl)({
            trigger: this.quoteIdentifier(tableName.slice(0,10) + '_' + autoIncrementKeys[ikey].slice(0,10) + '_TRG'),
